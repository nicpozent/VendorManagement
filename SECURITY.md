...
| Cross-user access to a review (IDOR) | **Owner-or-leadership check on every review sub-resource** — read, update, finish, delete, memo export, intake scan, reminder mail, attachments and history all enforce the same rule; managers can only reach their own reviews, leadership the whole portfolio. |
